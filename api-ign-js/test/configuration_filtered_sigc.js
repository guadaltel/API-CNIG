...
function fun(M_) {
   ...
   * @api stable
   */
  M_.config('MAPEA_URL', 'https://api-idee-sigc.desarrollo.guadaltel.es/api-core/');
   ...
   * @api stable
   */
  M_.config('PROXY_URL', `${location.protocol}//api-idee-sigc.desarrollo.guadaltel.es/api-core/api/proxy`);
   ...
   * @api stable
   */
  M_.config('PROXY_POST_URL', `${location.protocol}//api-idee-sigc.desarrollo.guadaltel.es/api-core/proxyPost`);
   ...
   * @api stable
   */
  M_.config('THEME_URL', `${location.protocol}//api-idee-sigc.desarrollo.guadaltel.es/api-core/assets/`);
  ...
  M_.config('attributions', {
    ...
    url: 'https://api-idee-sigc.desarrollo.guadaltel.es/api-core/files/attributions/WMTS_PNOA_20170220/atribucionPNOA_Url.kml',
    type: 'kml',
  });
