...
const estiloPoint = new M.style.Point({
  icon: {
    ...
    /**
           ...
           * Como valor devuelto por el return es la clase de IDEE que representa a la forma: M.style.form.TRIANGLE para el triÃ¡ngulo y M.style.form.CIRCLE para el cÃ­rculo
           */
    form(feature, map) {
