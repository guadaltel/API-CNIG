...
const estiloPoint = new M.style.Point({
  icon: {
    ...
    // Como valor devuelto por el return es la clase de IDEE que representa a la forma: M.style.form.TRIANGLE para el triángulo y M.style.form.CIRCLE para el cí­rculo
    form(feature, map) {
