...
outputJSON="/docker/vis_com-apicnig/0_desarrollo_dockerCompose/vis_com-apicnig/webapps/api-idee/WEB-INF/classes/resources_svg2.json"
echo '{"collection": []}' > "$outputJSON"

# Itera sobre cada carpeta proporcionada como parámetro
folderFather="/docker/vis_com-apicnig/0_desarrollo_dockerCompose/vis_com-apicnig/webapps/api-idee/assets/svg/"
