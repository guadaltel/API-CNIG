...
<%@ page import="es.idee.plugins.PluginsManager"%>
<%@ page import="es.idee.parameter.adapter.ParametersAdapterV3ToV4"%>
  ...
  layerOpts: [
    {
      id: "mapa",
      preview:
      `${M.config.IDEE_URL}/plugins/backimglayer/images/svqmapa.png`,
      title: "Mapa",
      layers: [
        new M.layer.WMTS({
    ...
    },
    {
      ...
      title: "Imagen",
      preview:
      `${M.config.IDEE_URL}/plugins/backimglayer/images/svqimagen.png`,
      layers: [
        new M.layer.WMTS({
    ...
    },
    {
      id: "lidar",
      preview:
      `${M.config.IDEE_URL}/plugins/backimglayer/images/svqlidar.png`,
      title: "LIDAR",
      layers: [
        new M.layer.WMTS({
    ...
    },
    {
      ...
      title: "Híbrido",
      preview:
      `${M.config.IDEE_URL}/plugins/backimglayer/images/svqhibrid.png`,
      layers: [
        new M.layer.WMTS({
          url: "http://www.ign.es/wmts/pnoa-ma?",
          name: "OI.OrthoimageCoverage",
